        ...
        (function (e) {
            ...
            function A(e, t, n, r, a) {
                ...
                if (a) {
                    ...
                    for (var c = !0, h = 0; h < s; h++) if (i(e, u + h) !== i(t, h)) {
                        c = !1;
                        break
                    }
                    if (c) return u
            ...
            function L(e, t, n) {
                ...
                for (var r = [], a = t; a < n;) {
                    var i = e[a], o = null, l = i > 239 ? 4 : i > 223 ? 3 : i > 191 ? 2 : 1;
                    if (a + l <= n) {
                        var s, u, p, c;
                        switch (l) {
                            case 1:
 ...
 */
            ...
            t.Buffer = o, t.SlowBuffer = m, t.INSPECT_MAX_BYTES = 50, o.TYPED_ARRAY_SUPPORT = void 0 !== e.TYPED_ARRAY_SUPPORT ? e.TYPED_ARRAY_SUPPORT : r(), t.kMaxLength = a(), o.poolSize = 8192, o._augment = function (e) {
                ...
                for (var i = a - r, l = n - t, s = Math.min(i, l), u = this.slice(r, a), p = e.slice(t, n), c = 0; c < s; ++c) if (u[c] !== p[c]) {
                    i = u[c], l = p[c];
                    break
                }
            ...
            o.prototype.slice = function (e, t) {
                ...
                var a, i = r - n;
                if (this === e && n < t && t < r) for (a = i - 1; a >= 0; --a) e[a + t] = this[a + n]; else if (i < 1e3 || !o.TYPED_ARRAY_SUPPORT) for (a = 0; a < i; ++a) e[a + t] = this[a + n]; else Uint8Array.prototype.set.call(e, this.subarray(n, n + i), t);
                return i
                ...
                if ("number" == typeof e) for (i = t; i < n; ++i) this[i] = e; else {
                    var l = o.isBuffer(e) ? e : G(new o(e, r).toString()), s = l.length;
        ...
        (function (e) {
            ...
            function i(e, t) {
                u.lastIndex = 0;
                var n = u.exec(e), r = n[1] || n[2], a = l.resolve(t, r);
                try {
            ...
            o.prototype.toJSON = function (e) {
                ...
                var t = this.toBase64(), n = "sourceMappingURL=data:application/json;charset=utf-8;base64," + t;
                ...
                return e = e.replace(/^\/\*/g, "//").replace(/\*\/$/g, ""), new o(e, {isEncoded: !0, hasComment: !0})
            }, t.fromMapFileComment = function (e, t) {
                return new o(e, {commentFileDir: t, isFileComment: !0, isJSON: !0})
        ...
        function r(e) {
            var t = e[1] || "", r = e[3];
            if (!r) return t;
            var a = n(4), i = a.fromObject(r).toComment({multiline: !0}), o = r.sources.map(function (e) {
        ...
        t.read = function (e, t, n, r, a) {
            var i, o, l = 8 * a - r - 1, s = (1 << l) - 1, u = s >> 1, p = -7, c = n ? a - 1 : 0, h = n ? -1 : 1,
                f = e[t + c];
            ...
            var o, l, s, u = 8 * i - a - 1, p = (1 << u) - 1, c = p >> 1,
                h = 23 === a ? Math.pow(2, -24) - Math.pow(2, -77) : 0, f = r ? 0 : i - 1, d = r ? 1 : -1,
                y = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
        ...
        function r(e) {
            for (var t = [], n = {}, r = 0; r < e.length; r++) {
                var a = e[r], i = a[0], o = a[1], l = a[2], s = a[3], u = {css: o, media: l, sourceMap: s};
        ...
        console.log("\n %c APlayer 1.6.0 %c http://aplayer.js.org \n\n", "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;"), n(0);
        var o = [], l = function () {
            function e(t) {
                function n(e) {
                ...
                if (this.option = t, this.audios = [], this.mode = t.mode, this.secondToTime = function (e) {
                    ...
                    var t = function (e) {
                            return e < 10 ? "0" + e : "" + e
                        }, n = parseInt(e / 60), r = parseInt(e - 60 * n), a = parseInt(n / 60),
                ...
                var g = this.element.getElementsByClassName("aplayer-thumb")[0], v = void 0;
                ...
                var b = function (e) {
                    var t = e || window.event, r = (t.clientX - n(y.barWrap)) / v;
                ...
                this.element.getElementsByClassName("aplayer-volume-bar-wrap")[0].addEventListener("click", function (e) {
                    var t = e || window.event, n = (E - t.clientY + r(A)) / E;
                ...
                key: "setMusic", value: function (e) {
                    ...
                    var r = function (e) {
                        for (var t = e.split("\n"), n = [], r = t.length, a = 0; a < r; a++) {
                            ...
                            if (null != i) for (var l = i.length, s = 0; s < l; s++) {
                    ...
                    if (this.option.showlrc) {
                        ...
                        if (!this.lrcs[a]) {
                            var i = "";
                            if (1 === this.option.showlrc) i = this.option.music[a].lrc; else if (2 === this.option.showlrc || this.option.showlrc === !0) i = this.savelrc[a]; else if (3 === this.option.showlrc) {
